...
const ContactsPage = () => {
    return (
        <div className="container py-5">
            <h1 className="mb-3 text-center text-purple page-hero-title">Contattaci</h1>
            <p className="text-center hero-subtitle mb-4">
                Hai domande o richieste? Compila il modulo qui sotto o scrivici ai nostri recapiti!
            </p>
            <div className="row justify-content-center">
                <div className="col-lg-7">
                    <form className="info-surface p-4 mb-4">
                        <div className="mb-3">
                        ...
                        <div className="d-grid">
                            <button type="submit" className="btn btn-purple btn-lg">Invia messaggio</button>
                        </div>
                    </form>
                    <div className="info-surface p-4 text-center">
                        <p className="mb-1">
                        ...
                        <p className="mb-1">
                            ...
                            <a href="tel:+39123456789" className="contact-link">+39 123 456 789</a>
                        </p>
                        <p>
